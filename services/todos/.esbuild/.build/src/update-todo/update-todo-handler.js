...
// src/update-todo/update-todo-handler.ts
var update_todo_handler_exports = {};
__export(update_todo_handler_exports, {
  main: () => main
});
module.exports = __toCommonJS(update_todo_handler_exports);
...
async function updateItem(keys, options) {
...
async function updateTodo(todoKeys, completed) {
